...
<div style="background-color:white;margin-top: 0px;padding-top:0px;" class="jumbotron jumbotron-fluid">
      <div class="row">
                  ...
                  <div class="col-3">
                              <img style="margin-left:-10px;height200px;" src="https://images.unsplash.com/photo-1434569842867-4d6d1d4d1ef0?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80" >
                  </div>
